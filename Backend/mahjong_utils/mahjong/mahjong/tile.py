...
class TilesConverter:
    ...
    @staticmethod
    def array_34_to_one_line_string(tiles_34: Collection[int], print_aka_dora: bool = False) -> str:
        """
        Convert 34 tiles array to the one line string
        Example of output with print_aka_dora=False: 1244579m3p57z
        Example of output with print_aka_dora=True:  1244079m3p57z
        """
        tiles_136 = TilesConverter.to_136_array(tiles_34)
        return TilesConverter.to_one_line_string(tiles_136, print_aka_dora)
